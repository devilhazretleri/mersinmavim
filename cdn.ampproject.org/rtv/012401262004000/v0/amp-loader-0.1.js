    ...
    f: function(a, t) {
        ! function() {
            ...
            function s(a) {
                ...
                return r && r.ownerDocument === t || (r = t.createElement("div")),
                    d
            }
                ...
                O = function() {
                    ...
                    return t.build = function() {
                            this.iaa = function(a) {
                                ...
                                this.aaa.appendChild(this.iaa),
                                this.eaa(),
                                this.raa()
                        },
                        t.raa = function() {
                            this.oaa() || this.laa() || (this.ae(),
                                this.maa() && this.iaa.classList.add("i-amphtml-new-loader-has-shim"),
                                this.saa())
                        },
                        t.ae = function() {
                        ...
                        t.saa = function() {
                            ...
                            this.iaa.querySelector(".i-amphtml-new-loader-logo").appendChild(i),
                                t && function(a, t, n, i, e) {
                        ...
                        t.uaa = function() {
                            var a = !!this.tp.getPlaceholder(),
                                t = this.tp.hasAttribute("poster");
                            return a || t
                        },
                        t.vaa = function() {
                            var a = this.tp.tagName;
                            return k[a] || m(a)
                        },
                        t.eaa = function() {
                        ...
                        t.maa = function() {
                            if (this.tp.hasAttribute("poster"))
                                return !0;
                            var a = this.tp.getPlaceholder();
                    ...
                    return a.prototype.initializeLoader = function(a, t, n, i, e) {
                            ...
                            new O(a, t, i, e).build(),
                                function(a, t) {
                                    var n = a.style;
                                    for (var i in t)
                                        n.setProperty(p(h(n, i)), String(t[i]), "important")
                                }(a, {
            ...
            a.registerServiceForDoc("loader", P),
                (y = a.win,
                    function(a, t) {
                        return function(a, t) {
                            u(function(a, t) {
                            ...
                            var n = function(a) {
                                ...
                                return t || (t = a.__AMP_SERVICES = {}),
                                    t
                            }(a)[t];
                            return n.obj || (u(n.ctor),
                                    u(n.context),
                        ...
                        var o = a.getHeadNode(),
                            l = function(a, t, n, e) {
                                ...
                                if (o) {
                                    var l = v(a, r, o);
                                    if (l)
                                        return "STYLE" == l.tagName && l.textContent !== t && (l.textContent = t),
                                            l
                                }
